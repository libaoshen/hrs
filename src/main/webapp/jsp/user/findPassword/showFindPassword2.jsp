...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/user/findPassword2.js"></script>
<% String action = request.getContextPath() + "/user/validatePhone";%>
<form  id="form1" action="<%=action %>" method="post" onsubmit="return validate(this)" >
		<table>
			...
			<tr>
				<td class="input1">电话号码</td>
				<td class="input2">
					<input type="hidden" name="userid" value="${userid}"/>
					<input id="input_1"  name="phone" maxlength="20"/>
				</td>
