...
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/css/user/findPassword1.css" />
<script type="text/javascript" src="<%=request.getContextPath()%>/js/user/findPassword1.js"></script>
<% String action = request.getContextPath() + "/user/validateUsername";%>
<form  id="form1" action="<%=action %>" method="post" onsubmit="return validate(this)" >
		...
		<table>
			...
			<tr>
				<td class="input1">用户名</td>
				<td class="input2">
					<input id="input_1"  name="username" maxlength="20"/>
				</td>
